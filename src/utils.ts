 ...
 */
export async function digest(bytes: Uint8Array<ArrayBuffer>, algorithm = 'SHA-256'): Promise<Uint8Array> {
 ...
 */
export function hexToBytes(input: bigint | string): Uint8Array<ArrayBuffer> {
