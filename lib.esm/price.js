...
exports.PHASE_OFFSET = exports.OFFCHAIN_ORACLE_ADDRESS = void 0;
...
const { formatUnits } = ethers_1.ethers;
/**
...
function getAggregatorRoundId(roundId) {
    return Number(BigInt(roundId) & ((BigInt(1) << BigInt(exports.PHASE_OFFSET)) - BigInt(1)));
}
/**
...
async function getChainlink(provider, symbolOrAddress, quoteSymbol = 'usd') {
    ...
    return typechain_1.DataFeed__factory.connect(chainlinkAddress, provider);
}
/**
