import { EnsResolver as EnsResolver$1, Contract, namehash, ZeroAddress, getAddress, dnsEncode, isError, Interface, isHexString, assertArgument, assert, EventLog, UndecodedEventLog, Log, toQuantity, FeeData, defineProperties, JsonRpcProvider, Network, AbiCoder, Transaction, parseEther, parseUnits, resolveProperties, VoidSigner, Wallet, HDNodeWallet, JsonRpcSigner, BrowserProvider as BrowserProvider$1, MaxUint256, Signature, formatUnits } from 'ethers';
...
class BrowserProvider extends BrowserProvider$1 {
  ethereum;
  appProvider;
  options;
  chainChanged;
...
export { ARB_CHAIN, ARB_GAS_LIMIT, BrowserProvider, CreateX__factory, DEFAULT_GAS_LIMIT, DEFAULT_GAS_LIMIT_BUMP, DEFAULT_GAS_PRICE_BUMP, DataFeed__factory, ERC20__factory, EnsResolver, EthersBatcher, FeeDataExt, GAS_LIMIT_FAILOVER, GAS_PRICE_ORACLE_ADDRESS, HARDHAT_CHAIN, IndexedDB, MULTICALL_ADDRESS, Multicall__factory, OFFCHAIN_ORACLE_ADDRESS, OffchainOracle__factory, OpGasPriceOracle__factory, PHASE_OFFSET, Permit2__factory, Provider, ProxySigner, WETH__factory, base64ToBytes, base64ToHex, bufferToBytes, bytesToBase64, bytesToHex, chainNames, chunk, compareBlockHashes, concatBytes, createBatchRateConfig, createBatchRequest, createBlockTags, crypto, digest, digestHex, ensRegistries, ensReverseNode, ensStaticResolvers, ensUniversalResolvers, index as factories, fetchBlockHashes, formatCallTrace, formatFeeHistory, getAggregatorRoundId, getBlockReceipts, getChainlink, getChainlinkPrice, getGasPrice, getL1Fee, getProof, getRateToEth, getStorageAt, getSubInfo, hexToBase64, hexToBytes, isDeferred, isHex, isNode, multiQueryFilter, multicall, permit, populateTransaction, rBytes, range, sleep, switchChain, toEvenHex, toFixedHex, traceBlock, traceTransaction, wildcardResolvers };
