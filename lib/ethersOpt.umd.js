(function (global, factory) {
    ...
    class Provider extends ethers.JsonRpcProvider {
      ...
      constructor(url, network, options) {
        ...
        this.staticNetwork = (async () => {
          ...
          const _network = ethers.Network.from(await new ethers.JsonRpcProvider(url).getNetwork());
    ...
    class ProxySigner {
      ...
      async sendTransaction(tx) {
        if (this.parentSigner instanceof ethers.JsonRpcSigner || this.#wrappedProvider) {
    ...
    async function permit(erc20, spenderOrSigner, value = ethers.MaxUint256, deadline = ethers.MaxUint256) {
      const token = erc20;
