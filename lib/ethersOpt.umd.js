...
__webpack_require__.d(__webpack_exports__, {
  ...
  DataFeed__factory: () => (/* reexport */ DataFeed__factory),
  ...
  HARDHAT_CHAIN: () => (/* reexport */ HARDHAT_CHAIN),
  ...
  PHASE_OFFSET: () => (/* reexport */ PHASE_OFFSET),
  Permit2__factory: () => (/* reexport */ Permit2__factory),
  Provider: () => (/* reexport */ Provider),
  ProxySigner: () => (/* reexport */ ProxySigner),
  WETH__factory: () => (/* reexport */ WETH__factory),
  ...
  createBatchRateConfig: () => (/* reexport */ createBatchRateConfig),
  ...
  getAggregatorRoundId: () => (/* reexport */ getAggregatorRoundId),
  getBlockReceipts: () => (/* reexport */ getBlockReceipts),
  getChainlink: () => (/* reexport */ getChainlink),
  getChainlinkPrice: () => (/* reexport */ getChainlinkPrice),
  getGasPrice: () => (/* reexport */ getGasPrice),
  getL1Fee: () => (/* reexport */ getL1Fee),
  getProof: () => (/* reexport */ getProof),
  getRateToEth: () => (/* reexport */ getRateToEth),
  getStorageAt: () => (/* reexport */ getStorageAt),
...
;// ./src/typechain/factories/DataFeed__factory.ts


const { Contract: DataFeed_factory_Contract, Interface: DataFeed_factory_Interface } = ethers;
const DataFeed_factory_abi = [
  {
    inputs: [],
    name: "aggregator",
    outputs: [
...
class DataFeed__factory {
  static abi = DataFeed_factory_abi;
  static createInterface() {
    return new DataFeed_factory_Interface(DataFeed_factory_abi);
  }
  static connect(address, runner) {
    return new DataFeed_factory_Contract(address, DataFeed_factory_abi, runner);
  }
}
...
;// ./src/typechain/factories/WETH__factory.ts


const { Contract: WETH_factory_Contract, Interface: WETH_factory_Interface } = ethers;
const WETH_factory_abi = [
  {
    constant: true,
    inputs: [],
    name: "name",
...
class WETH__factory {
  static abi = WETH_factory_abi;
  static createInterface() {
    return new WETH_factory_Interface(WETH_factory_abi);
  }
  static connect(address, runner) {
    return new WETH_factory_Contract(address, WETH_factory_abi, runner);
  }
}
...
const { BrowserProvider: ethBrowserProvider, JsonRpcSigner: browserProvider_ethJsonRpcSigner, toQuantity: browserProvider_toQuantity } = ethers;
async function switchChain(chainId, ethereum, params) {
  try {
    await ethereum.request({
      method: "wallet_switchEthereumChain",
      params: [{ chainId: browserProvider_toQuantity(chainId) }]
    });
  } catch (switchError) {
    if (switchError.code === 4902 || ethereum.isTrust) {
      await ethereum.request({
        ...
        params: [
          {
            chainId: browserProvider_toQuantity(chainId),
...
class BrowserProvider extends ethBrowserProvider {
  ...
  async getSigner(address) {
    ...
    return new ProxySigner(new browserProvider_ethJsonRpcSigner(this, signerAddress), {
      ...this.options,
