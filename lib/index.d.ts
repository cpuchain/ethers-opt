 ...
 */
export declare function digest(bytes: Uint8Array<ArrayBuffer>, algorithm?: string): Promise<Uint8Array>;
/**
 ...
 */
export declare function hexToBytes(input: bigint | string): Uint8Array<ArrayBuffer>;
/**
